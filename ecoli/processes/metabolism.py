...
# `test_metabolism_listener` removed during vendoring into vParCa:
# it imported `ecoli.experiments.ecoli_master_sim`, which is part of the
# vivarium-ecoli simulation side we are not vendoring.
